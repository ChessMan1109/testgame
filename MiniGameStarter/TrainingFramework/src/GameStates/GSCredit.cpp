...
void GSCredit::Init()
{
	...
	m_Text1 = std::make_shared< Text>(shader, font, "Players will press the W, S, A and D keys to up, down,", TEXT_COLOR::BLACK, 1.0);
	m_Text1->Set2DPosition(Vector2(20, screenHeight / 2));
	m_Text2 = std::make_shared< Text>(shader, font, "left and right the Space key to shoot bullets.", TEXT_COLOR::BLACK, 1.0);
	m_Text2->Set2DPosition(Vector2(50, screenHeight / 2+50));
}
void GSCredit::Exit()
{
